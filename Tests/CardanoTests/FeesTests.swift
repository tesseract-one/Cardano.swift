...
final class FeesTests: XCTestCase {
    func testTxSimpleUtxo() throws {
        ...
        XCTAssertEqual(try signedTx.minFee(linearFee: linearFee), 94002)
    }
    ...
    func testTxSimpleByronUtxo() throws {
        ...
        XCTAssertEqual(try signedTx.minFee(linearFee: linearFee), 112002)
    }
    ...
    func testTxMultiUtxo() throws {
        ...
        XCTAssertEqual(try signedTx.minFee(linearFee: linearFee), 183502)
    }
    ...
    func testTxRegisterStake() throws {
        ...
        XCTAssertEqual(try signedTx.minFee(linearFee: linearFee), 269002)
    }
    ...
    func testTxWithdrawal() throws {
        ...
        XCTAssertEqual(try signedTx.minFee(linearFee: linearFee), 162502)
    }
}
