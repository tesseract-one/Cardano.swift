...
final class FeesTests: XCTestCase {
    func testTxSimpleUtxo() throws {
        ...
        XCTAssertEqual(try LinearFee.minFee(tx: signedTx, linearFee: linearFee), 94002)
    }
    ...
    func testTxSimpleByronUtxo() throws {
        ...
        XCTAssertEqual(try LinearFee.minFee(tx: signedTx, linearFee: linearFee), 112002)
    }
    ...
    func testTxMultiUtxo() throws {
        ...
        XCTAssertEqual(try LinearFee.minFee(tx: signedTx, linearFee: linearFee), 183502)
    }
    ...
    func testTxRegisterStake() throws {
        ...
        let registrationCert = PoolRegistration(
            poolParams: PoolParams(
                ...
                vrfKeyhash: try VRFKeyHash(
                    bytes: blake2b256(data: Data(hex: "fbf6d41985670b9041c5bf362b5262cf34add5d265975de176d613ca05f37096")!)
                ),
                pledge: 1000000,
                cost: 1000000,
        ...
        XCTAssertEqual(try LinearFee.minFee(tx: signedTx, linearFee: linearFee), 269002)
    }
    ...
    func testTxWithdrawal() throws {
        ...
        XCTAssertEqual(try LinearFee.minFee(tx: signedTx, linearFee: linearFee), 162502)
    }
}
